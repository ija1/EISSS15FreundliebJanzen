  ...
  private void Consume()
  {
      Thread thread = new Thread()
      {
           ...
           @Override
              public void run() {
               while(Running){
            	   // Mit Hilfe der Klasse QueueingConsumer werden die Nachrichten empfangen,
            	   // die Methode nextDelivery nimmt die eingehenden Nachrichten entgegen und gibt diese zurück
