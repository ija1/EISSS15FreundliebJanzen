...
public class ProfileDisplay extends Activity {
	     ...
	     */
   		...
   		public void onCreate(Bundle savedInstanceState) {
   			...
   			final TextView jobcoachvorname = (TextView) findViewById(R.id.jobcoachvorname);
   			final TextView jobcoachnachname = (TextView) findViewById(R.id.jobcoachnachname);
   			...
   			jobcoachvorname.append(user.getJobcoachVorname());
   	   		jobcoachnachname.append(user.getJobcoachNachname()); 
